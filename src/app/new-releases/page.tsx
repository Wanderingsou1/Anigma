...
import { getNewReleases, AniListUnavailableError } from "@/lib/api/anilist";
...
export default async function NewReleasesPage({
  ...
  try {
    result = await getNewReleases(page, 24);
  } catch (error) {
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-10">
          ...
          {loadError ? (
            <div className="text-center py-24">
              ...
              <h3 className="text-xl font-bold font-[Outfit] text-white mb-2">New releases are temporarily unavailable</h3>
